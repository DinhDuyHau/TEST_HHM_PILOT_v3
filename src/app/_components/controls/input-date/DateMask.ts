...
export class DateMask {
    ...
    private moveKeys: Array<string> = ['Home', 'End', 'Tab'];

    private display: string = '';
    private value: string = '';

    private maxCaretPosition: number | null | undefined;
    ...
    private keydown(event: any): any {
        ...
        const caret: number | null = element.selectionStart;
