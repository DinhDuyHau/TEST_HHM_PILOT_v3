...
class YA {
  ...
  acquireVideoStream(A) {
    ...
    const g = new JA();
    // const defaultDeviceId = localStorage.getItem('strich_device_id');
    ...
    //   I => I.deviceId == defaultDeviceId,
    // );
    // console.log(device);
    // if (device) {
    //   I.video.deviceId = {exact: device.deviceId};
    // }
    return this.getAvailableDevices()
      ...
      .then(() => {
        ...
        return navigator.mediaDevices.getUserMedia(I).catch(A => {
  ...
  selectCameraDevice(A) {
    ...
    let I = this.availableDevices.find(I => I.deviceId == A);
    if (I) {
      localStorage.setItem('strich_device_id', A);
    } else {
      localStorage.setItem('strich_device_id', '');
      I = this.availableDevices[0];
    }
    return I
      ? (this.mediaStream &&
          (this.mediaStream.getTracks().forEach(A => A.stop()),
...
class bA {
  ...
  static logo =
    'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAIkAAAASCAYAAABvhf1JAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAACxIAAAsSAdLdfvwAAAAhSURBVGhD7cExAQAAAMKg9U9tCU8gAAAAAAAAAAAAOKoBJpoAAeVTgMkAAAAASUVORK5CYII=';
  ...
  initialize() {
    ...
    return (
      ...
      C.initialize()
        ...
        .then(A => {
          //const deviceId = localStorage.getItem('strich_device_id') || '';
          // if (deviceId) {
