...
import { MasterInfo, Merchandise, StockShopCheckTicket, TAB_NAME } from './model/model';
import { STOCK_SHOP_CHECK_TICKET_ENTITY, STOCK_SHOP_CHECK_TICKET_CODE } from './model/constants';
...
export class StockShopCheckService {
    ticket!: StockShopCheckTicket;
    option!: Option;
    ...
    //#region setter
    setTicket(ticket: StockShopCheckTicket, option: Option) {
        this.ticket = ticket;
        this.option = option;
    }
    ...
    initTicket(ticket: StockShopCheckTicket) {
        ...
        ticket.masterInfo.ma_ct = STOCK_SHOP_CHECK_TICKET_CODE;
        ...
        this.ticketApiService.getVoucherNumber(STOCK_SHOP_CHECK_TICKET_ENTITY).subscribe(result => {
    ...
    getImeiInStore(imei: string) {
        return this.imeiApiService.getImeiInStore(imei, this.ticket.masterInfo.ma_cuahang, STOCK_SHOP_CHECK_TICKET_CODE);
    }
    ...
    validateTicket(ticket: StockShopCheckTicket): string {
        let message = '';
