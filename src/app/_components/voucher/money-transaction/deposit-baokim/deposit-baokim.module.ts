...
import { DepositBaokimComponent } from './deposit-baokim.component';
...
import { DepositBaokimDetailComponent } from './create/create.component';
...
@NgModule({
  declarations: [DepositBaokimComponent, DepositBaokimDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [DepositBaokimComponent, DepositBaokimDetailComponent]
})
export class DepositBaokimModule { }
