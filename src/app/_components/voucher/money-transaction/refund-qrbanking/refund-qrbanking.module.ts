...
import { RefundQrBankingDetailComponent } from './create/refund-qrbanking-detail.component';
...
@NgModule({
  declarations: [RefundQrBankingDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [RefundQrBankingDetailComponent]
})
export class RefundQrBankingModule { }
