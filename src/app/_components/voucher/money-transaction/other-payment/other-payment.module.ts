...
import { OtherPaymentDetailComponent } from './create/create.component';
import { VoucherInfoModule } from '@app/sales-management/component/form-control-custom/voucher-info/voucher-info.module';
@NgModule({
  declarations: [OtherPaymentComponent, OtherPaymentDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [OtherPaymentComponent, OtherPaymentDetailComponent]
})
export class OtherPaymentModule { }
