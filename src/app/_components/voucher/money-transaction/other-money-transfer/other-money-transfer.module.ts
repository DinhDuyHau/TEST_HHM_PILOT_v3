...
import { OtherMoneyTransferComponent } from './other-money-transfer.component';
...
import { OtherMoneyTransferDetailComponent } from './create/create.component';
...
@NgModule({
  declarations: [OtherMoneyTransferComponent, OtherMoneyTransferDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [OtherMoneyTransferComponent, OtherMoneyTransferDetailComponent]
})
export class OtherMoneyTransferModule { }
