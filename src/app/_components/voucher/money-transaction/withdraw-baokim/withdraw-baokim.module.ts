...
import { WithdrawBaokimComponent } from './withdraw-baokim.component';
...
import { WithdrawBaokimDetailComponent } from './create/create.component';
...
@NgModule({
  declarations: [WithdrawBaokimComponent, WithdrawBaokimDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [WithdrawBaokimComponent, WithdrawBaokimDetailComponent]
})
export class WithDrawBaokimModule { }
