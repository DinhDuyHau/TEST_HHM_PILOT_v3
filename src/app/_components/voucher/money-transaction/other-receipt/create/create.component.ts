...
import { Receipt, ReceiptDetail } from '../other-receipt.model';
...
import { OtherReceiptDetailService } from './other-receipt-detail.service';
...
export class OtherReceiptDetailComponent extends Grid<ReceiptDetail> implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    public OtherReceiptDetailService: OtherReceiptDetailService,
    ...
    private OtherReceipt: OtherReceiptService,
