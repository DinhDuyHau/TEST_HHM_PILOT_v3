...
import { CollectionReceiptDetailComponent } from './create/create.component';
...
@NgModule({
  declarations: [CollectionReceiptComponent, CollectionReceiptDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [CollectionReceiptComponent, CollectionReceiptDetailComponent]
})
