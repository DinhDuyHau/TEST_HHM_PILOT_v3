...
import { DeposistReceiptComponent } from './deposist-receipt.component';
...
import { DeposistReceiptDetailComponent } from './create/create.component';
...
@NgModule({
  declarations: [DeposistReceiptComponent, DeposistReceiptDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [DeposistReceiptComponent, DeposistReceiptDetailComponent]
})
export class DeposistReceiptModule { }
