...
import { DeposistReturnReceiptComponent } from './deposist-return-payment.component';
...
import { DeposistReturnReceiptDetailComponent } from './create/create.component';
...
@NgModule({
  declarations: [DeposistReturnReceiptComponent, DeposistReturnReceiptDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [DeposistReturnReceiptComponent, DeposistReturnReceiptDetailComponent]
})
export class DeposistReturnReceiptModule { }
