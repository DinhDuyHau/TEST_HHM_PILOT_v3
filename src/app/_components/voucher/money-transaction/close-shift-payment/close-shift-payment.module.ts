...
import { CloseShiftPaymentComponent } from './close-shift-payment.component';
...
import { CloseShiftPaymentDetailComponent } from './create/create.component';
import { VoucherInfoModule } from '@app/sales-management/component/form-control-custom/voucher-info/voucher-info.module';
@NgModule({
  declarations: [CloseShiftPaymentComponent, CloseShiftPaymentDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [CloseShiftPaymentComponent, CloseShiftPaymentDetailComponent]
})
export class CloseShiftPaymentModule { }
