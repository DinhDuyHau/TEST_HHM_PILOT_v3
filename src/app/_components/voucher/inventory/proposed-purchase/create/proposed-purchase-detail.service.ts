...
import { ReceiptDetail } from '../proposed-purchase.model';
...
export class ProposedPurchaseDetailService implements IGridService<ReceiptDetail>{
  ...
  getFields(): Observable<Field[]> {
    ...
    return this.http.get<Field[]>(`assets/fields/grid/proposed-purchase_detail.json?r=${randomParam}`).pipe(
      switchMap(data => {
        data = data.map((item) => {
