...
import { LoanOutComponent } from './loan-out.component';
...
import { LoanOutDetailComponent } from './create/create.component';
...
@NgModule({
  declarations: [LoanOutComponent, LoanOutDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [LoanOutComponent, LoanOutDetailComponent]
})
export class LoanOutModule { }
