...
import { ReceiptDetail } from '../loan-out.model';
...
export class LoanOutDetailService implements IGridService<ReceiptDetail>{
  ...
  getFields(): Observable<Field[]> {
    ...
    return this.http.get<Field[]>(`assets/fields/grid/loan-out_detail.json?r=${randomParam}`).pipe(
      switchMap(data => {
        data = data.map((item) => {
