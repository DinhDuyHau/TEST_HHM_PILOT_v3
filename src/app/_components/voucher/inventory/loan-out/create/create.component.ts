...
import { Receipt, ReceiptDetail } from '../loan-out.model';
...
import { LoanOutDetailService } from './loan-out-detail.service';
...
export class LoanOutDetailComponent extends Grid<ReceiptDetail> implements OnInit, AfterViewInit {
  ...
  cancelButtonTitle = '';
  [key: string]: any
  entity = VOUCHER_TYPE.LOAN_OUT.sysid;
  isDisabled = false;
  readonly = false;
  ...
  constructor(
    ...
    public returnSupplierDetailService: LoanOutDetailService,
    ...
    private returnSupplier: LoanOutService,
