...
import { ReceiptDetail } from '../warranty-out.model';
...
export class WarrantyOutDetailService implements IGridService<ReceiptDetail>{
  ...
  getFields(): Observable<Field[]> {
    ...
    return this.http.get<Field[]>(`assets/fields/grid/warranty-out_detail.json?r=${randomParam}`).pipe(
      switchMap(data => {
        data = data.map((item) => {
