...
import { ReceiptDetail } from '../warranty-in.model';
...
export class WarrantyInDetailService implements IGridService<ReceiptDetail>{
  ...
  getFields(): Observable<Field[]> {
    ...
    return this.http.get<Field[]>(`assets/fields/grid/warranty-in_detail.json?r=${randomParam}`).pipe(
      switchMap(data => {
        data = data.map((item) => {
