...
import { EventGiftComponent } from './event-gift.component';
...
import { EventGiftDetailComponent } from './create/create.component';
...
@NgModule({
  declarations: [EventGiftComponent, EventGiftDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [EventGiftComponent, EventGiftDetailComponent]
})
