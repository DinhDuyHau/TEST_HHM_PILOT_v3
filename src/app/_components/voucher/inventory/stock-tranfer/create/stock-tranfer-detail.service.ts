...
import { ReceiptDetail } from '../stock-tranfer.model';
...
export class StockTranferDetailService implements IGridService<ReceiptDetail>{
  ...
  getFields(): Observable<Field[]> {
    ...
    return this.http.get<Field[]>(`assets/fields/grid/stock-tranfer_detail.json?r=${randomParam}`).pipe(
      switchMap(data => {
        data = data.map((item) => {
