...
import { ReturnSupplierDetailComponent } from './create/create.component';
...
@NgModule({
  declarations: [ReturnSupplierComponent, ReturnSupplierDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [ReturnSupplierComponent, ReturnSupplierDetailComponent]
})
export class ReturnSupplierModule { }
