...
import { ReceiptDetail } from '../stock-tranfer-in.model';
...
export class StockTranferInDetailService implements IGridService<ReceiptDetail>{
  ...
  getFields(): Observable<Field[]> {
    ...
    return this.http.get<Field[]>(`assets/fields/grid/stock-tranfer-in_detail.json?r=${randomParam}`).pipe(
      switchMap(data => {
        data = data.map((item) => {
