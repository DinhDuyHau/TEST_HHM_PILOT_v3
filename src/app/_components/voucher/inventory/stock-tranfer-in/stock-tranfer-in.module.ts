...
import { StockTranferInComponent } from './stock-tranfer-in.component';
import { StockTranferInCreateComponent } from './create/create.component';
...
@NgModule({
  declarations: [
    StockTranferInComponent,
    StockTranferInCreateComponent
  ],
  imports: [
    CommonModule,
    DirModule,
...
export class StockTranferInModule { }
