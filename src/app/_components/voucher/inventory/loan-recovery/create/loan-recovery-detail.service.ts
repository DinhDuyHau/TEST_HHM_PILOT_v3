...
import { ReceiptDetail } from '../loan-recovery.model';
...
export class LoanRecoveryDetailService implements IGridService<ReceiptDetail>{
  ...
  getFields(): Observable<Field[]> {
    ...
    return this.http.get<Field[]>(`assets/fields/grid/loan-recovery_detail.json?r=${randomParam}`).pipe(
      switchMap(data => {
        data = data.map((item) => {
