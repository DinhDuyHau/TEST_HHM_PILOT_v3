...
import { LoanRecoveryComponent } from './loan-recovery.component';
...
import { LoanRecoveryDetailComponent } from './create/create.component';
import { VoucherInfoModule } from '@app/sales-management/component/form-control-custom/voucher-info/voucher-info.module';
@NgModule({
  declarations: [LoanRecoveryComponent, LoanRecoveryDetailComponent],
  imports: [
    CommonModule,
    DirModule,
    RouterModule,
  ...
  exports: [LoanRecoveryComponent, LoanRecoveryDetailComponent]
})
