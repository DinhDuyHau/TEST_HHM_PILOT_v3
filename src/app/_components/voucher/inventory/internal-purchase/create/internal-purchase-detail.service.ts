...
import { ReceiptDetail } from '../internal-purchase.model';
...
export class InternalPurchaseDetailService implements IGridService<ReceiptDetail>{
  ...
  getFields(): Observable<Field[]> {
    ...
    return this.http.get<Field[]>(`assets/fields/grid/internal-purchase_detail.json?r=${randomParam}`).pipe(
      switchMap(data => {
        data = data.map((item) => {
