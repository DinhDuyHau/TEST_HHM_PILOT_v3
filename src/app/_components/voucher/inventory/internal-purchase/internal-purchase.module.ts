...
import { InternalPurchaseComponent } from './internal-purchase.component';
import { InternalPurchaseCreateComponent } from './create/create.component';
...
@NgModule({
  declarations: [
    InternalPurchaseComponent,
    InternalPurchaseCreateComponent,
  ],
  imports: [
    CommonModule,
    DirModule,
...
export class InternalPurchaseModule { }
