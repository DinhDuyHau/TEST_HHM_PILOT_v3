...
const GET_TAX_SERVICE_BUYBACK_URL = `${environment.apiUrl}/price/get_tax_service_buyback`;
...
export class MerchandiseServiceApiService extends ApiService {
    ...
    getTaxServiceBuyback(ma_dichvu: string): Observable<ResultNoPaging<Service>> {
        return this.get<ResultNoPaging<Service>>(GET_TAX_SERVICE_BUYBACK_URL, { ma_dichvu });
    }
