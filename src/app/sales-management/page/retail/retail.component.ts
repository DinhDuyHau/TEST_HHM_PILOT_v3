...
export class RetailComponent implements OnInit, AfterViewInit {
  ...
  onSave() {
    ...
    const invalid_tax_merchandise = this.ticket.merchandise.some(x => !(x.tien_thue + 2 > Math.round(x.thanh_tien * x.thue_suat / 100) && x.tien_thue - 2 < Math.round(x.thanh_tien * x.thue_suat / 100)));
