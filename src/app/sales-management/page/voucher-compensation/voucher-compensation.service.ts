...
import { MasterInfo, Merchandise, RetailSaleTicket, TAB_NAME } from '@app/sales-management/model/ticket/voucher-compensation/model';
...
import { MerchandiseRequest, MasterInfoRequest } from '@app/sales-management/model/ticket/voucher-compensation/request.model';
...
export class VoucherCompensationService {
    ...
    initTicket(ticket: RetailSaleTicket) {
        ...
        ticket.masterInfo.ma_ct = TICKET_CODE.STOCK_COMPENSATION;
    ...
    getImeiInStore(imei: string) {
        return this.imeiApiService.getImeiInStore(imei, this.ticket.masterInfo.ma_cuahang, TICKET_CODE.STOCK_COMPENSATION);
    }
    ...
    calcDiscount(loai_ck = ''): Observable<ResultNoPaging<Discount>> | undefined {
        ...
        const entity = TICKET_ENTITY.STOCK_COMPENSATION;
