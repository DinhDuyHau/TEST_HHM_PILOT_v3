...
export class DiscountService {
    ...
    resetDiscount(discounts: any[], isGridItem: boolean = false) {
        ...
        if (isGridItem) {
            ...
            const discount_keep_adv = discounts.filter(e => e.loai_ck !== DISCOUNT_TYPE.GIFT && e.loai_ck !== DISCOUNT_TYPE.REDUTION_FOR_CUSTOMER);
